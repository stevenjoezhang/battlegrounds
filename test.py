...
def test19():
    ...
    ba.set_heropower(hero2="Reborn Rites")
    return ba
def test20():
    ba = battlefeild()
    ba.quick_add_up("Wrath Weaver", 84, 84, golden=True)
    ba.quick_add_up('Selfless Hero', 20, 18,golden=True)
    ba.quick_add_up('Imprisoner', 16, 12, taunt=True,golden=True)
    ba.quick_add_up("Selfless Hero",4,3)
    ba.quick_add_up("Baron Rivendare")
    ba.quick_add_up("Phalanx Commander",24,26,golden=True)
    ba.quick_add_up("Soul Juggler",17,17,golden=True)
    ba.quick_add_down("Cave Hydra", 20, 19)
    ba.quick_add_down("Selfless Hero", golden=True)
    ba.quick_add_down("Maexxna")
    ba.quick_add_down("Maexxna")
    ba.quick_add_down("Savannah Highmane", golden=True)
    ba.quick_add_down("Baron Rivendare", golden=True)
    ba.quick_add_down('Goldrinn, the Great Wolf', 6, 6, taunt=True)
    return ba
def test21():
    ba = battlefeild()
...
def test22():# 修正位置bug
    ba=battlefeild()
    ba.quick_add_up("Rat Pack",taunt=True)
    ba.quick_add_up("Kangor's Apprentice",4,7)
    ba.quick_add_up("Ghastcoiler",23,23)
    ba.quick_add_up("Baron Rivendare",2,8)
    ba.quick_add_down("Ironhide Direhorn",25,22,golden=True)
    ba.quick_add_down("Ironhide Direhorn",15,15)
    ba.quick_add_down("Harvest Golem")
    ba.quick_add_down("Mecharoo")
    ba.quick_add_down("Baron Rivendare",2,8)
    ba.set_heropower(hero2="Reborn Rites")
    return ba